...
INSERT INTO "new_Booking" ("date", "email", "fullName", "id", "phone", "seatsRequired", "status", "workspaceId") SELECT "date", "email", "fullName", "id", "phone", "seatsRequired", "status", "workspaceId" FROM "Booking";
DROP TABLE "Booking";
